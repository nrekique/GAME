...
const menu = {
    ...
    'Menu/File/Save as...': { path: ['File', 'Save Document as...'], shortcut: { key: 'S', modifiers: ['Ctrl', 'Shift', ] } },
    ...
    'Menu/Edit/Delete': { path: ['Edit', 'Delete'], shortcut: { key: 'Backspace', modifiers: [] } },
    ...
    'Menu/View/Maximize Current View': { path: ['View', 'Maximize Current View'], shortcut: { key: 'Space', modifiers: ['Meta', ] } },
    'Menu/File/Preferences...': { path: ['View', 'Preferences...'], shortcut: { key: ',', modifiers: ['Ctrl', ] } },
    ...
    'Menu/Help/TrenchBroom Manual': { path: ['Help', 'TrenchBroom Manual'], shortcut: { key: '?', modifiers: ['Ctrl', ] } },
