...
const TRIGGER_EXIT_SCRIPT := preload("res://entities/triggers/trigger_exit.gd")
const TRIGGER_HURT_SCRIPT := preload("res://entities/triggers/trigger_hurt.gd")
const COLLECTIBLE_SCRIPT := preload("res://entities/items/collectible.gd")
